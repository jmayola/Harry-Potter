    ...
    <CommentsContextProvider>
      {Comments.map((Comments) => (
        <div key={Comments.id} onClick={() => EditComment(Comments.id)}>
          <div className=" m-auto bg-[#8F0F0F] p-4 m-5 hover:border-[#0D113C] border-[#1B285E] border-4 rounded-3xl box-border text-slate-100 w-96 justify-center align-middle">
            <img
              src={Comments.image}
              alt=""
